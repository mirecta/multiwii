...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
      ...
      //#define DESQUARED6DOFV4    // DEsquared V4 with MPU6050mwc se 2.5 spi 
      //#define LADYBIRD
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /*******************************    SBUS RECIVER    ************************************/
      ...
      /*******************************    MIRC RECEIVER    ************************************/
      /* The following line apply only for Mirec  Receiver */
      #define MIRC
      
      #define MIRC_MOSI_PORT C
      #define MIRC_MOSI_PIN  1  //A1 
      #define MIRC_MISO_PORT C
      #define MIRC_MISO_PIN  0  //A0
      #define MIRC_SCK_PORT  C
      #define MIRC_SCK_PIN   2  //A2
      #define MIRC_SS_PORT   D
      #define MIRC_SS_PIN    4  //D4
        
      #define MIRC_CONCAT(a,b) a ## b
      #define MIRC_OUTPORT(name) MIRC_CONCAT(PORT,name)
      #define MIRC_INPORT(name)  MIRC_CONCAT(PIN, name)
      #define MIRC_DDRPORT(name) MIRC_CONCAT(DDR, name)

      
      #define MIRC_MOSI_PORTOUT MIRC_OUTPORT(MIRC_MOSI_PORT) 
      #define MIRC_MOSI_PORTDDR MIRC_DDRPORT(MIRC_MOSI_PORT)
      
      #define MIRC_MISO_PORTOUT MIRC_OUTPORT(MIRC_MISO_PORT)
      #define MIRC_MISO_PORTIN  MIRC_INPORT(MIRC_MISO_PORT) 
      #define MIRC_MISO_PORTDDR MIRC_DDRPORT(MIRC_MISO_PORT)
      
      #define MIRC_SCK_PORTOUT MIRC_OUTPORT(MIRC_SCK_PORT)
      #define MIRC_SCK_PORTDDR MIRC_DDRPORT(MIRC_SCK_PORT)
      
      #define MIRC_SS_PORTOUT MIRC_OUTPORT(MIRC_SS_PORT)
      #define MIRC_SS_PORTDDR MIRC_DDRPORT(MIRC_SS_PORT)
